...
const mutations = {
  setBackgroundDetails (state, payload) {
    state.backgroundDetails.push(payload)
    console.log(state.backgroundDetails)
  },
  shiftBackgroundDetails (state) {
    state.backgroundDetails.shift()
  }
}
...
const actions = {
  ...
  shiftBackgroundDetails (context) {
    context.commit('shiftBackgroundDetails')
  }
}
